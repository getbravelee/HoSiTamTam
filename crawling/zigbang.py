...
def getAptInfoData(danjiId):
    ...
    if req.status_code == 200:
        ...
        danjisRoomTypes = data["pageProps"]["SSRData"]["danjisRoomTypes"]
        school_zones = data["pageProps"]["SSRData"]["schoolZones"]

        average_rent_price = danjisRoomTypes["average_rent_price"]
        average_sales_price = danjisRoomTypes["average_sales_price"]
        minSalesPrice = danjisRoomTypes["minSalesPrice"]
        maxSalesPrice = danjisRoomTypes["maxSalesPrice"]
        room_types = danjisRoomTypes["room_types"]
